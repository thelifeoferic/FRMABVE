  ...
  return (
    <main className="fa-site">
      <header className="fa-nav">
        ...
        <nav aria-label="Primary navigation"><a href="#work">Work</a><a href="#capabilities">Capabilities</a><a href="#approach">Approach</a><Link href="/asheville">Asheville Dispensary</Link></nav>
