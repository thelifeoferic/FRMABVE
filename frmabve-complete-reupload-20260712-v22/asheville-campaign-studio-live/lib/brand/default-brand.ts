...
export const campaignBrands: Record<BrandId, CampaignBrand> = {
  "asheville-dispensary": {
    ...
    logoSrc: "/brand-imagery/asheville-round-logo.png",
    heroSrc: "/brand-imagery/asheville-leaf-hero.jpg",
    heroAlt: "Cannabis leaves growing outdoors for Asheville Dispensary",
  ...
  "plant-bar": {
    ...
    logoSrc: "/brand-kit/plant-bar/plant-bar-logo-wide.png",
